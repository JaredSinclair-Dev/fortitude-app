    ...
    <>
      ...
      <style>{`
        ...
        @media(max-width:768px){
          ...
          .main-content{padding:16px 14px 76px!important}
          ...
          /* Touch targets */
          .ni{min-height:44px!important}
          .btn{min-height:44px!important}
          /* Headings */
          h1.df-h1{font-size:22px!important}
          /* Hide calendar on mobile dashboard — too narrow */
          .dash-cal-mobile{display:none!important}
          /* Full-width cards */
          .mc{padding:14px!important}
          /* Chat input fix */
          .community-grid > div:first-child{min-height:0}
        }
        .mob-topbar{
          position:fixed;top:0;left:0;right:0;height:52px;z-index:100;
          background:rgba(10,13,20,.97);border-bottom:1px solid ${C.border};
          align-items:center;justify-content:space-between;padding:0 16px;
          backdrop-filter:blur(16px);
        }
        .mob-bottomnav{
          position:fixed;bottom:0;left:0;right:0;height:60px;z-index:100;
          background:rgba(10,13,20,.97);border-top:1px solid ${C.border};
          align-items:center;justify-content:space-around;
          backdrop-filter:blur(16px);
        }
        .mob-navitem{
          display:flex;flex-direction:column;align-items:center;gap:3px;
          padding:6px 10px;cursor:pointer;flex:1;min-width:0;
          color:${C.textDim};font-size:9px;letter-spacing:.04em;text-transform:uppercase;
          transition:color .18s;-webkit-tap-highlight-color:transparent;
        }
        .mob-navitem.mob-active{color:${C.accent}}
        .mob-drawer{position:fixed;inset:0;z-index:200;display:flex}
        .mob-overlay{position:absolute;inset:0;background:rgba(6,8,16,.88)}
        .mob-panel{
          position:relative;width:270px;height:100%;overflow-y:auto;
          background:rgba(10,13,20,.99);border-right:1px solid ${C.border};
      ...
      <div style={{ display:"flex",minHeight:"100vh",position:"relative" }}>
        ...
        <div className="mob-topbar">
          ...
          <div style={{ display:"flex",alignItems:"center",gap:10 }}>
            <div style={{ padding:"3px 9px",background:`${currentTierMeta.color}15`,borderRadius:4,border:`1px solid ${currentTierMeta.color}30` }}>
        ...
        {/* Main content */}
        <main className="main-content" style={{ flex:1,padding:"28px 32px",overflowY:"auto",position:"relative",zIndex:1,WebkitOverflowScrolling:"touch" }}>
