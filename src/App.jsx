        ...
        {mode === "login" && (
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            ...
            <div style={{ textAlign:"center", marginTop:4 }}>
              <span style={{ fontSize:12, color:"#29a8ff", cursor:"pointer" }}>Forgot password?</span>
            </div>
          </div>
        )}
        ...
        <div className="fi">
          <div className="mc" style={{ marginBottom:14 }}>
            ...
            <div style={{ display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:12 }}>
              <div><label style={{ fontSize:11,color:C.textDim,display:"block",marginBottom:6,letterSpacing:".07em",textTransform:"uppercase" }}>Email Address</label><input className="inp" defaultValue={user?.email || ""}/></div>
