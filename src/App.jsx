  ...
  return (
    <div className="fi">
      <div style={{ marginBottom: 20, display:"flex", alignItems:"flex-start", justifyContent:"space-between", gap:16 }}>
        <div>
          <h1 className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize: 28, fontWeight: 300, marginBottom: 6 }}>Market Intelligence Dashboard</h1>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 360px", gap:16, alignItems:"start" }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          ...
          <div style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12 }}>
            {[{l:"Analyses Completed",v:"47",s:"This month",c:C.accent},{l:"Current Tier",v:"FMF Owner",s:"Full access",c:C.accent},{l:"Course Progress",v:"68%",s:"FMF Course",c:C.gold},{l:"Community Posts",v:"12",s:"Contributions",c:C.textMuted}].map(m=>(
              <div key={m.l} className="mc">
                ...
                <div className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:26,color:m.c,fontWeight:400,lineHeight:1.1 }}>{m.v}</div>
          ...
          {/* PDI summary banner */}
          <div className="mc" style={{ display:"flex",alignItems:"center",gap:18,padding:"14px 20px",borderColor:pdiMeta.color,background:`linear-gradient(90deg,rgba(13,16,24,.92),${pdiMeta.color}08)`,cursor:"pointer" }} onClick={()=>setPage("behavioral")}>
          ...
          <div className="mc" style={{ borderLeft:`3px solid ${C.accent}` }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:12 }}>
              <div>
                ...
                <div className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:18,color:C.text,fontWeight:400 }}>DXY Compression Phase — Structural Context</div>
              </div>
    ...
    return (
      <div className="fi">
        <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:24 }}>
          ...
          <h1 className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:24, fontWeight:300, margin:0 }}>Assessment Results</h1>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))", gap:10, marginBottom:14 }}>
          {[
            ...
            <div key={m.l} className="mc" style={{ textAlign:"center" }}>
              ...
              <div className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:20, color:m.c, fontWeight:400 }}>{m.v}</div>
            </div>
          ))}
        </div>
          ...
          <div className="mc" style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center" }}>
            ...
            <div style={{ position:"relative", width:120, height:120 }}>
              ...
              <div style={{ position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center" }}>
                <span className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:28, color:pdiColor, lineHeight:1 }}>{behavioral.pdi}</span>
            ...
            {[
              ...
              <div key={m.t}>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:6 }}>
                  ...
                  <span className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:14, color:(m.invert ? m.v < 20 : m.v >= 70) ? C.accent : C.pink }}>{m.v}</span>
                </div>
    ...
    return (
      <div className="fi">
        <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:24 }}>
          ...
          <h1 className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:24, fontWeight:300, margin:0 }}>Preview Import</h1>
    ...
    return (
      <div className="fi">
        <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:24 }}>
          ...
          <h1 className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:24, fontWeight:300, margin:0 }}>Select Platform</h1>
        </div>
        {detectedPlatform && (
          <div className="mc" style={{ marginBottom:14, borderLeft:`3px solid ${C.accent}` }}>
  ...
  return (
    <div className="fi">
      ...
      <div style={{ marginBottom:20 }}>
        <h1 className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:28, fontWeight:300, marginBottom:6 }}>Performance Journal</h1>
...
const Pricing = ({ currentTier, setPage, onUpgrade, subStatus, setSubStatus }) => {
  ...
  return (
    <div className="fi">
      <div style={{ marginBottom:28 }}>
        <div style={{ display:"flex",alignItems:"baseline",gap:14,marginBottom:6 }}>
          <h1 className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:28,fontWeight:300 }}>Membership</h1>
          ...
          return (
            <div key={t.id} style={{ border:`1px solid ${isCurrent?t.color:C.border}`,borderRadius:8,padding:18,background:isCurrent?`linear-gradient(135deg,rgba(13,16,24,.95),${t.color}08)`:"rgba(13,16,24,.82)",backdropFilter:"blur(8px)",display:"flex",flexDirection:"column",transition:"all .2s",position:"relative" }}
              ...
              <div style={{ marginBottom:14 }}>
                ...
                <div className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:26,color:isCurrent?t.color:C.text,fontWeight:300,lineHeight:1 }}>{price}</div>
          ...
          return (
            <div key={a.id} className="mc" style={{ display:"flex",alignItems:"center",gap:18,opacity:accessible?1:.6 }}>
              ...
              <div style={{ textAlign:"right",flexShrink:0 }}>
                <div className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:20,color:C.gold,fontWeight:300,marginBottom:8 }}>{a.price}</div>
...
const Account = ({ currentTier, setTier, setPage, aiUsed, subStatus, setSubStatus, onUpgrade }) => {
  ...
  return (
    <div className="fi">
      <div style={{ marginBottom:24 }}>
        <h1 className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:28,fontWeight:300,marginBottom:6 }}>Account</h1>
      ...
      <div className="mc" style={{ marginBottom:18,borderColor:tier.color,display:"flex",gap:18,alignItems:"center",padding:"14px 20px" }}>
        <div style={{ width:44,height:44,borderRadius:"50%",background:`${tier.color}18`,border:`1px solid ${tier.color}50`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0 }}>
          <span className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:19,color:tier.color }}>J</span>
        </div>
        <div>
        ...
        <div className="fi">
          ...
          <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,marginBottom:18 }}>
            <div className="mc" style={{ borderColor:subStatus==="active"?tier.color:C.gold }}>
              ...
              <div className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:22,color:subStatus==="active"?tier.color:C.gold,fontWeight:300,marginBottom:6 }}>{tier.label}</div>
              <div style={{ display:"flex",flexDirection:"column",gap:6 }}>
                {[
  ...
  return (
    <div className="fi">
      <div style={{ marginBottom:22 }}>
        <h1 className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:28,fontWeight:300,marginBottom:6 }}>Administration</h1>
      ...
      <div style={{ display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:10,marginBottom:18 }}>
        {[{l:"Total Members",v:"284",s:"+12 this month",c:C.accent},{l:"Active Subscriptions",v:"142",s:"50% conversion",c:C.accent},{l:"MRR",v:"$9,840",s:"+$420 this month",c:C.gold},{l:"AI Calls Today",v:"347",s:"Within budget",c:C.accent},{l:"Flagged",v:"3",s:"Requires review",c:C.pink}].map(m=>(
          <div key={m.l} className="mc" style={{ borderColor:m.c==="C.pink"?C.pinkDim:undefined }}>
            <div className="sl">{m.l}</div>
            <div className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:24,color:m.c,fontWeight:400 }}>{m.v}</div>
...
export default function App() {
  ...
  useEffect(() => { window.__fortitudeNav = setPage; return () => { delete window.__fortitudeNav; }; }, []);
      ...
      try {
        ...
        api.get("/membership/access", savedToken).then(data => {
          if (data.success) {
            ...
            setSubStatus(["active","trial"].includes(data.data.subscriptionStatus) ? "active" : "inactive");
          ...
          <div style={{ paddingTop:12,borderTop:`1px solid ${C.border}` }}>
            ...
            <div style={{ display:"flex",alignItems:"center",gap:9 }}>
              <div style={{ width:28,height:28,borderRadius:"50%",background:C.accentGlow,border:`1px solid ${C.accentDim}`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0 }}>
                <span className="df" style={{fontFamily:"'Counter-Strike',sans-serif", fontSize:13,color:C.accent }}>J</span>
              </div>
              <div>
