...
export default function App() {
  ...
  // Tier state — in production: from JWT / DB. Here switchable for demo.
  const [tier,      setTier]      = useState("65");   // demo: Fortitude Pro
  const [aiUsed,    setAiUsed]    = useState(2);
  const [subStatus, setSubStatus] = useState("active"); // active | expired | cancelled
